...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/css/dark-mode.css')}}">
</head>
<body class="animsition">
	...
	<header class="header-v4">
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 js-show-cart">
                            <a href="#" style="color:black"><i class="zmdi zmdi-account-circle"></i></a>
						</div>
		...
		<div class="wrap-header-mobile">
			...
			<div class="wrap-icon-header flex-w flex-r-m m-r-15">
				...
				<div class="icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 js-show-cart">
                    <a href="#" style="color:#fff"><i class="zmdi zmdi-account-circle"></i></a>
				</div>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="{{URL::to('/gio-hang')}}" class="label1 rs1" data-label1="hot">Features</a>
				</li>
		...
		<div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
			<div class="container-search-header">
				<button class="flex-c-m btn-hide-modal-search trans-04 js-hide-modal-search">
					<img src="{{'public/frontend/images/icons/icon-close2.png'}}" alt="CLOSE">
				</button>
	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				...
				<div class="dis-none panel-search w-full p-t-10 p-b-15">
					...
					<div class="bor8 dis-flex p-l-15">
						...
						<input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" name="keywords_submit"
							placeholder="Search">
					</div>
                    </form>
				</div>
            ...
            <div id="all_product" class="row"></div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women"> -->
                    ...
                    <!-- <div class="block2">
                        <div class="block2-pic hov-img0 label-new" data-label="New">
                            <img src="{{URL::to('public/uploads/product/'.$product -> product_image)}}" alt="IMG-PRODUCT">
									...
									<div class="item-slick3" data-thumb="images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											...
											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
												href="{{'public/frontend/images/product-detail-01.jpg'}}">
    ...
    <script src="{{ asset('public/frontend/js/dark-mode-switch.min.js')}}"></script>
            ...
            <div class="p-t-40">
                ...
                <p class="stext-107 cl6 txt-center">
                    ...
                    <script>
                        ...
                        aria-hidden="true"></i> by <a href="https://www.facebook.com/huuthuat.nguyen.940/" target="_blank">Hữu Thuật</a>
